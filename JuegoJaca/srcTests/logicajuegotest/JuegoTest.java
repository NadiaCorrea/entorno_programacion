...
public class JuegoTest {
	...
	// Test ID:1 - Constructor con par�metros
	@Test
	void constructorConParametrosTest() {
		...
		assertEquals("El pr�ximo jugador no es correcto", PlayerType.OGRO.name(), juego.getNombreJuegadorQueJuega());
	...
	void imprimirNombreJugadoresTest() {
		...
		assertTrue("El resultado de imprimir los nombres de los jugadores est� vac�o", result.length() > 0);
	}
	...
	void imprimirValoresJugadoresTest() {
		...
		assertTrue("El resultado los valores de los jugadores est� vac�o", result.length() > 0);
	}

	// Test ID:8 - Establecer pr�ximo jugador
	@Test
	...
	// Test ID:9 - Establecer pr�ximo jugador al �ltimo
	@Test
	...
	void obtenerGanadorSinGanadorTest() {
		...
		assertEquals("El nombre del ganador no es vac�o", 0, jugador.length());
	}
	...
	// Test ID:12 - Obtener ganador por �ltimo jugador
	@Test
