...
class CoordenadaTest {
	...
	// Test ID:1 - Constructor sin par�metros
	@Test
	void constructorNoParamTest() {
		...
		assertTrue("Constructor sin par�metros", actualX >= 0 && actualX <= 9);
		assertTrue("Constructor sin par�metros", actualY >= 0 && actualY <= 9);
	}

	// Test ID:2 - Constructor con par�metros v�lidos
	@Test
	...
	// Test ID:3 - Constructor con par�metros no v�lidos
	@Test
	...
	// Test ID:4 - Constructor con par�metro X no v�lido
	@Test
	...
	// Test ID:5 - Constructor con par�metro Y no v�lido
	@Test
	...
	void goRightTrueTest() {
		...
		assertEquals("No aument� en valor", 4, original.getX());
	}
	...
	void goRightFalseTest() {
		...
		assertEquals("Aument� en valor", 9, original.getX());
	}
	...
	void goLeftTrueTest() {
		...
		assertEquals("No disminuy� en valor", 2, original.getX());
	}
	...
	void goLeftFalseTest() {
		...
		assertEquals("Disminuy� en valor", 0, original.getX());
	}
	...
	void goUpTrueTest() {
		...
		assertEquals("No disminuy� en valor", 5, original.getY());
	}
	...
	void goUpFalseTest() {
		...
		assertEquals("Disminuy� en valor", 0, original.getY());
	}
	...
	void goDownTrueTest() {
		...
		assertEquals("No disminuy� en valor", 9, original.getY());
	}
	...
	void goDownFalseTest() {
		...
		assertEquals("Disminuy� en valor", 9, original.getY());
	}
