...
public class mainJuego {
	...
	public static void main(String[] args) throws JugadorException {
		...
		try {
			...
			/**
			 * Hay que elegir qué jugador va a ser cada uno, pero no se permiten jugadores
			 * repetidos
			 */
			int numJugadores = 0;
			...
			while (!juego.isTerminado()) {
				...
				System.out.println("Le toca al jugador " + juego.getNombreJuegadorQueJuega() + ". El dado saca "
						+ juego.getValorDado() + " movimientos");
