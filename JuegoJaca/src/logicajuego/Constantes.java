...
public class Constantes {
	...
	public static final int GANA_DINERO = 2; // Gana el jugador y se lleva la totalidad del dinero del enemigo
	...
	public static final int PIERDE_DINERO = 5; // Gana el enemigo y se lleva la totalidad del dinero del jugador
